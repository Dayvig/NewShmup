...
public class WeaponMountData : ScriptableObject
{
    ...
    [SerializeField] public bool rotateToWayPointBeforeTicking;
    ...
    [SerializeField] public bool moveToWayPointBeforeTicking;
    ...
    [SerializeField] public bool fireAtSpecificIntervals;
    [SerializeField] public List<float> fireIntervals;
    [SerializeField] public bool reloadAllWeaponsAtOnce;

    [SerializeField] public float delayOnSpawn;
    [SerializeField] public float randomDelayOffset;
